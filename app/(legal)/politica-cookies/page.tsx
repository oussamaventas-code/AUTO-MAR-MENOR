...
export const metadata: Metadata = {
  ...
  description: 'Política de cookies de Auto Mar Menor. Información sobre el uso de cookies en nuestro sitio web.',
};
  ...
  return (
    <>
      ...
      <p>
        ...
        te informamos sobre el uso de cookies en el sitio web automarmenor.es.
      </p>
      ...
      <ul>
        <li><strong>amm-cookies-accepted:</strong> Almacena tu preferencia sobre el aviso de cookies. Duración: 1 año.</li>
      </ul>
      ...
      <p>
        ...
        <a href="mailto:info@automarmenor.es">info@automarmenor.es</a>.
      </p>
    </>
  );
}
