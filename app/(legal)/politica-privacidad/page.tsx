...
export const metadata: Metadata = {
  ...
  description: 'Política de privacidad y protección de datos de Auto Mar Menor conforme al RGPD.',
};
...
export default function PoliticaPrivacidad() {
  return (
    <>
      ...
      <p>
        En AUTO MAR MENOR SL nos comprometemos a proteger tu privacidad. Esta Política de
      ...
      <ul>
        <li><strong>Responsable:</strong> AUTO MAR MENOR SL</li>
        <li><strong>CIF/NIF:</strong> B30446413</li>
        <li><strong>Dirección:</strong> Calle Mar Menor (Santa María de Gracia), 2 - Edif. Barnés BJ, 30009 Murcia</li>
        <li><strong>Email:</strong> info@automarmenor.es</li>
        <li><strong>Teléfono:</strong> 661 22 36 31</li>
      </ul>
      ...
      <p>
        ...
        <a href="mailto:info@automarmenor.es">info@automarmenor.es</a> o en nuestro
      ...
      <h2>8. Seguridad</h2>
      <p>
        AUTO MAR MENOR SL ha adoptado las medidas técnicas y organizativas necesarias para
