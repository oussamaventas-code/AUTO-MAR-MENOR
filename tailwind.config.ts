  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "bosch-glow": "radial-gradient(circle at 50% 50%, rgba(0,164,255,0.18), transparent 60%)",
      ...
      boxShadow: {
        glow: "0 0 60px -10px rgba(0,164,255,0.45)",
        "glow-sm": "0 0 30px -8px rgba(0,164,255,0.35)",
