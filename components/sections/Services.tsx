      ...
      <div className="container-x">
        <div className="mb-16 flex flex-col gap-6 md:mb-24 md:flex-row md:items-end md:justify-between">
          ...
          <p className="max-w-md text-bone-200/80">
            Equipos Bosch oficiales, técnicos certificados y recambio OEM. La calidad de
            un concesionario sin sus precios, ni sus esperas.
          </p>
        </div>
...
function ServiceCard({ service }: { service: (typeof SERVICES)[number] }) {
  ...
  return (
    ...
    >
      <span className="svc-bg pointer-events-none absolute inset-0 bg-bosch-glow opacity-0" />
      ...
      <div className="relative mt-auto flex items-center justify-between">
        ...
        <span className="svc-arrow text-bosch">
