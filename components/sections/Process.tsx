...
export function Process() {
  ...
  return (
    ...
    >
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -left-40 top-1/3 h-[480px] w-[480px] rounded-full bg-bosch-glow opacity-[0.07] blur-3xl"
      />
      <div className="container-x">
        ...
        <div className="proc-list relative">
          <div className="proc-line absolute left-[28px] top-2 bottom-2 hidden w-px bg-gradient-to-b from-bosch via-white/10 to-transparent md:block" />
            ...
            {PROCESS.map((p, i) => (
              ...
              >
                <div className="relative">
                  <div className="grid h-14 w-14 place-items-center rounded-full border border-white/10 bg-ink-800 font-mono text-sm tracking-widest text-bosch-glow">
                    {p.step}
                  </div>
                </div>
